...
<div id="peta" style="width: auto; height:480px;"></div>
      <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDua6wdMgcICXPTa9fSUqGcIJCoRl_hlJU"></script>
    ...
    <?php
          ...
          include ('panel/koneksi.php');
              ...
              while($data=mysql_fetch_object($result)){
                ...
                {
                  $bri = " <img src='img/bri.png' width='60px' height='34px'>";
                }
                 ...
                 ?>
                    ["<div role='tabpanel' style='width:400px;height:290px;overflow:hidden;'>"+ 
                            "<ul class='nav nav-tabs' role='tablist'>"+
                                "<li role='presentation' class='active'><a href='detail.php?id=<?=$data->id_market; ?>' aria-controls='info'><b>Detail Minimarket</b></a></li>"+
                            "</ul>"+
