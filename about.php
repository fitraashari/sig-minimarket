  ...
  <body>
    <div class="be-wrapper be-nosidebar-left">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">About</h2>
          </div>
          ...
          <div class="row">
            <div class="col-xs-12 col-md-6 col-md-offset-3">
              <div class="panel panel-default">
                <div class="panel-heading"><span class="title">About</span></div>
                <div class="panel-body">
                  <p>Sistem Informasi Pemetaan <b>Minimarket</b> Di Wilayah Karesidenan Surakarta Dan Sekitarnya, Sistem Ini Di Buat Untuk Memenuhi Tugas UAS Sistem Informasi Geografi.</p>
                </div>
                <pre class="prettyprint">Di Buat oleh
                <br>Mohammad Fitra Ashari [14.4.00064] Sebagai Programmer & Perancang Sistem<br>Radika F [14.4.00084] Sebagai Pengumpul Data & Desain                </pre>
              </div>
            </div>
          </div>
        </div>
